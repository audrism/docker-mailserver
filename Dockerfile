...
# echo "audris:x:22923:2343:Audris Mockus:/home/audris:/bin/bash" >>
# /etc/passwd && echo "da:x:2343:" >> /etc/group &&
# mkdir /home/audris && chown audris:da /home/audris && sed -i 's/^$/+ : audris : ALL/' /etc/security/access.conf && echo "audris ALL=(ALL) NOPASSWD: ALL" > /etc/sudoers.d/audris
